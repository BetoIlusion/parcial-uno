                ...
                <div class="flex items-center justify-center space-x-6">
                    ...
                    <a href="{{ route('diagramas.show', $item->id) }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M17.414 2.586a2 2 0 010 2.828l-9.9 9.9a1 1 0 01-.39.242l-4 1.333a1 1 0 01-1.263-1.263l1.333-4a1 1 0 01.242-.39l9.9-9.9a2 2 0 012.828 0z" />
                        </svg>
                    </a>
                    {{-- BOTÓN EXPORTAR --}}
                ...
                <ul class="divide-y divide-gray-200">
                    @foreach ($users as $user)
                        <li class="py-1 px-2 flex items-center hover:bg-yellow-50 rounded transition">
                            <div class="flex-shrink-0 h-6 w-6 rounded-full bg-yellow-200 flex items-center justify-center text-yellow-800 font-semibold text-xs">
